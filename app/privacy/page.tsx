  ...
  return (
    <article className="container legal-page">
      ...
      <section>
        <h2>Cookie等について</h2>
        <p>
          当サイトでは、利便性の向上、利用状況の把握、広告配信等のために、Cookie等を使用する場合があります。利用者はブラウザの設定によりCookieの受け入れを変更できます。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          当サイトでは、今後アフィリエイト広告やPRリンクを掲載する場合があります。広告リンク経由で商品・サービスの申込みがあった場合、当サイトが報酬を受け取る場合があります。
        </p>
        <p>
          広告・PRを含む場合は、その旨が分かるように表示します。商品・サービスの申込みは、利用者自身の判断で行ってください。
        </p>
      </section>
