...
export function PracticeClient({ practiceYears }: PracticeClientProps) {
  ...
  const randomQuestionCount = Math.min(
    RANDOM_PRACTICE_QUESTION_COUNT,
  ...
  if (!selectedSession) {
    return (
      <article className="practice-page practice-hero-page practice-hero-practice">
        <section
        ...
        <div className="container practice-page-content">
          <section
            ...
            aria-labelledby="practice-random-heading"
          >
                ...
                <div>
                  ...
                  <dd>
                    {isSeenQuestionMapLoaded
                      ? `${seenStats.seenCount}問 / ${seenStats.totalCount}問`
                      : "確認中"}
                  </dd>
                </div>
                <div>
          ...
          <section
            className="section-block"
            aria-labelledby="practice-year-heading"
          >
            <div className="section-heading compact-heading">
