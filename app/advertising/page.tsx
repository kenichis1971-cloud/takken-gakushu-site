...
export default function AdvertisingPage() {
  return (
    <article className="legal-page advertising-page advertising-hero-page">
      <section
        className="advertising-hero"
        aria-labelledby="advertising-page-heading"
      >
        <div className="container advertising-hero-inner">
          <div>
            <p className="eyebrow">Advertising / PR</p>
            <h1 id="advertising-page-heading">広告・PRについて</h1>
            <p>
      ...
      <div className="container advertising-page-content">
        <section>
        ...
        <section
          className="notice-box advertising-related-links"
          aria-labelledby="advertising-related-heading"
        >
          <h2 id="advertising-related-heading">関連ページ</h2>
          <p>
            宅建講座を検討する前の整理や、サイト利用に関する方針もあわせて確認できます。
          </p>
