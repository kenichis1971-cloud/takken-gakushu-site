...
export default function PastPage() {
  ...
  return (
    <article className="past-page past-hero-page past-hero-past">
      <section className="past-hero" aria-labelledby="past-page-heading">
        <div className="container past-hero-inner">
          <div>
      ...
      <div className="container past-page-content">
        <section
          className="section-block"
          aria-labelledby="past-status-heading"
        >
        ...
        <section
          className="past-summary card"
          aria-labelledby="past-summary-heading"
        >
          <div>
        ...
        <section
          className="next-actions past-next-actions"
